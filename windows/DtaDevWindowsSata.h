 ...
 * device
 */
class DtaDevWindowsSata: public DtaDevWindowsScsi {
public:

    static
        DtaDevWindowsSata*
        getDtaDevWindowsSata(const char* devref, DTA_DEVICE_INFO& di);

  /** Sata Windows specific method to send an ATA command to the device
  ...
  DtaDevWindowsSata(OSDEVICEHANDLE _osDeviceHandle)
    : DtaDevWindowsScsi(_osDeviceHandle)
  {}
